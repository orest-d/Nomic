...
COPYING.LESSER and COPYING for the exact licensing terms and conditions.

Note:
Scala Nomic contains two software packages:
"Scala Nomic Meno", which is distributed under GNU General Public Licence and
"Scala Nomic Runtime" (this package), which is distributed under GNU Lesser General Public Licence.
